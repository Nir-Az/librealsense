    ...
    */
    ...
    void ac_trigger::check_conditions()
    {
        ...
        default:
            if( ! invalid_reason.empty() )
                invalid_reason += ", ";
            invalid_reason += to_string() << "invalid (" << raw_gain << ") gain preset";
            break;
        }
